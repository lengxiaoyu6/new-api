...
type Channel struct {
	...
	StatusCodeResponseMapping *string `json:"status_code_response_mapping" gorm:"type:text"`
...
func (channel *Channel) GetStatusCodeResponseMapping() string {
	if channel.StatusCodeResponseMapping == nil {
		return ""
	}
	return *channel.StatusCodeResponseMapping
}
