...
func InitOptionMap() {
	...
	common.OptionMap["InviterTopupRebatePercent"] = strconv.FormatFloat(common.InviterTopupRebatePercent, 'f', -1, 64)
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "InviterTopupRebatePercent":
		common.InviterTopupRebatePercent, _ = strconv.ParseFloat(value, 64)
