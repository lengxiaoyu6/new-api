...
func ModelPriceHelper(c *gin.Context, info *relaycommon.RelayInfo, promptTokens int, meta *types.TokenCountMeta) (hosttypes.PriceData, error) {
	...
	if definition.BillingMode == billing_setting.BillingModeTieredExpr {
		return modelPriceHelperTiered(c, info, billingModelName, definition, promptTokens, groupRatioInfo)
	}
...
func modelPriceHelperTiered(c *gin.Context, info *relaycommon.RelayInfo, billingModelName string, definition billing_setting.BillingDefinition, promptTokens int, groupRatioInfo hosttypes.GroupRatioInfo) (hosttypes.PriceData, error) {
